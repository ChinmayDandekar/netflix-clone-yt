...
function Banner({ netflixOriginals }: Props) {
    ...
    return (
        <div className='flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[85vh] lg:justify-end lg:pb-10'>
            ...
            <p className='max-w-xs text-xs text-shadow-md md:max-w-lg 
            md:text-lg lg:max-w-2xl lg:text-2xl'>{movie?.overview}</p>
